...
### Changed
- Support the br v0.2.x backend (bd-32ab)

## [0.11.1] - 2026-06-08

### Fixed
- Fix idle multi-instance SQLite lock errors from background refresh loop (ab-nr68)

### Changed
- Skip long-running integration tests in the default unit test target
